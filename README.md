...
* **EJS (Embedded JavaScript):** Templating engine for dynamic HTML rendering on the server side.
* **Authentication:** Secure **user authentication** using **Passport.js** (or similar session/token-based approach) and **Express Sessions**.
